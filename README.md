...
Note that the --enable-autodependencies flag is not supported on MacOS.  See the [manual](./NCPA_prop_manual.pdf) for detailed information on additional parameters.
